...
public class TransferenciaVIP extends JFrame {
	...
	public TransferenciaVIP() {
		...
		confirmarTransf.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (numContaInt == EstruturaGUI.contaNormal.getNumConta()) {
					EstruturaGUI.contaVIP.transferencia(EstruturaGUI.contaNormal, valorTransferDouble);
					caixaValorTransf.setText("");
					caixaContaNum.setText("");
				} else {
					JOptionPane.showMessageDialog(transferencia.getComponent(0), 
							"Conta não existe ou digitou errado ou transferiu para você mesmo");
				}
			}
		});
